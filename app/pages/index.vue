...
<template>
	<div class="page-container">
		...
		<div v-if="userStore.globalLinesCleared > 0" class="global-lines">
			<div class="pixel-text">TOTAL LINES: {{ userStore.globalLinesCleared }}</div>
		</div>
			...
			<div class="footer-content">
				...
				<div class="footer-section">
					...
					<div class="footer-links">
						<a href="https://github.com/Elnop/red-tetris" target="_blank" rel="noopener noreferrer" class="footer-link">
						...
						<a href="https://projects.intra.42.fr/42cursus-red-tetris/mine" target="_blank" rel="noopener noreferrer" class="footer-link">
